...
public class userProgramPoprawione {
    ...
    private static void add(int id) { // naraziue nie da sie dodawac rozwiazan Cannot add or
        ...
        if(solutioncheck.getDescription()==null)
        {
            ...
            solution solution = new solution(); // jak sprawdzic czy id ktore dodajemy istnieje jako zadanie
